...
public class Contact_Us {
	...
	*/
	...
	/**
	* Input object
	* @method WebElement formInput_Input_emailAutomationid(WebDriver driver)
	*/
	public static WebElement formInput_Input_emailAutomationid(WebDriver driver){
		return driver.findElement(By.xpath("//input[@automationid='input_email']"));
	}

	/**
	* Input object
	* @method WebElement formInput_Input_passwordAutomationid(WebDriver driver)
	*/
	public static WebElement formInput_Input_passwordAutomationid(WebDriver driver){
		return driver.findElement(By.xpath("//input[@automationid='input_password']"));
	}

	/**
	* Input object
	* @method WebElement formInput_Input_checkboxAutomationid(WebDriver driver)
	*/
	public static WebElement formInput_Input_checkboxAutomationid(WebDriver driver){
